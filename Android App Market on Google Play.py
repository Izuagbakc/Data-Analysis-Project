...
# Read in dataset
import pandas as pd
apps_with_duplicates = pd.read_csv("downloads/apps.csv")
...
apps_with_size_and_rating_present = apps.query('Rating != "NaN" and Size != "Nan"')
...
reviews_df = pd.read_csv("downloads/user_reviews.csv")
